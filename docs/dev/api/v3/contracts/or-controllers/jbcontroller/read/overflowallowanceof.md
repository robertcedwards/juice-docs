...
* `_terminal` is the [`IJBPaymentTerminal`](/dev/api/v3/interfaces/ijbpaymentterminal.md) managing the overflow.
...
* The function returns:
  ...
  * `overflowAllowanceCurrency` is the currency from [`JBCurrencies`](/dev/api/v3/libraries/jbcurrencies.md) that the returned overflow allowance is in terms of.
