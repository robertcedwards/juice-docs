...
1.  Pay the splits of the specified project, domain, and group.
    ...
    * [`splitsStore`](/dev/api/v3/contracts/or-utilities/jbetherc20splitspayer/properties/splitsstore.md)
...
2.  Emit a `DistributeToSplitGroup` event with the relevant parameters.
    ...
    * [`DistributeToSplitGroup`](/dev/api/v3/contracts/or-utilities/jbetherc20splitspayer/events/distributetosplitgroup.md)
