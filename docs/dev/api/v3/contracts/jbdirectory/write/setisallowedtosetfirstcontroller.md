...
1.  Set the allowlist property for the provided address to the flag's value.
    ...
    * [`isAllowedToSetFirstController`](/dev/api/v3/contracts/jbdirectory/properties/isallowedtosetfirstcontroller.md)
2.  Emit a `SetIsAllowedToSetFirstController` event with the relevant parameters.
    ...
    * [`SetIsAllowedToSetFirstController`](/dev/api/v3/contracts/jbdirectory/events/setisallowedtosetfirstcontroller.md)
