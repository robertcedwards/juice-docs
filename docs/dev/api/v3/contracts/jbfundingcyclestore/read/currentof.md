...
* The function returns the project's current [`JBFundingCycle`](/dev/api/v3/data-structures/jbfundingcycle.md).
...
2.  Get a reference to the configuration of an eligible funding cycle if there is one. This eligible cycle might not yet be approved.
    ...
    * [`_eligibleOf`](/dev/api/v3/contracts/jbfundingcyclestore/read/-_eligibleof.md)
