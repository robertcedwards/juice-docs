...
* The function returns a [`JBFundingCycle`](/dev/api/v2/data-structures/jbfundingcycle.md) struct.
...
3.  Get the stored intrinsic properties of the funding cycle. Populate the struct values by unpacking the `uint256`.
    ...
    * [`_packedIntrinsicPropertiesOf`](/dev/api/v2/contracts/jbfundingcyclestore/properties/-_packedintrinsicpropertiesof.md)
