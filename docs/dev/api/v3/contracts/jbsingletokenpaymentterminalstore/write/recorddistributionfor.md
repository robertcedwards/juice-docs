...
Contract: [`JBSingleTokenPaymentTerminalStore`](/dev/api/v3/jbdirectory/write/)​‌
...
3.  Calculate the new total amount that has been distributed during this funding cycle by adding the amount being distributed to the used distribution limit.
    ...
    * [`usedDistributionLimitOf`](/dev/api/v3/contracts/jbsingletokenpaymentterminalstore/properties/useddistributionlimitof.md)
