...
* Through the [`requirePermission`](/dev/api/v3/contracts/or-abstract/jboperatable/modifiers/requirepermission.md) modifier, the function is only accessible by the project's owner, or from an operator that has been given the [`JBOperations.SET_METADATA`](/dev/api/v3/libraries/jboperations.md) permission by the project owner for the provided `_projectId`.
...
1.  Store the project's new metadata content within the specified domain.
    ...
    * [`metadataContentOf`](/dev/api/v3/contracts/jbprojects/properties/metadatacontentof.md)
2.  Emit a `SetMetadataCid` event with the relevant parameters.
    ...
    * [`SetMetadata`](/dev/api/v3/contracts/jbprojects/events/setmetadata.md)
