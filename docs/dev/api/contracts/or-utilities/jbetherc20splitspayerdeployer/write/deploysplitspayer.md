...
Contract: [`JBETHERC20SplitsPayerDeployer`](/dev/api/v3/contracts/or-utilities/jbetherc20splitspayerdeployer/README.md)

Interface: [`IJBETHERC20SplitsPayerDeployer`](/dev/api/v3/interfaces/ijbetherc20splitspayerdeployer.md)
...
* The function overrides a function definition from the[`IJBETHERC20SplitsPayerDeployer`](/dev/api/v3/interfaces/ijbetherc20splitspayerdeployer.md) interface.
...
1.  Deploy the splits payer contract.
    ...
    * [`JBETHERC20SplitsPayer`](/dev/api/v3/contracts/or-utilities/jbetherc20splitspayer)
2.  Emit a `DeploySplitsPayer` event with all relevant parameters.
    ...
    * [`DeploySplitsPayer`](/dev/api/v3/contracts/or-utilities/jbetherc20splitspayerdeployer/events/deploysplitspayer.md)
