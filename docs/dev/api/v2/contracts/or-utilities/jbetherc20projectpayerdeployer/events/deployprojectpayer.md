...
* [`deployProjectPayer`](/dev/api/v2/contracts/or-utilities/jbetherc20projectpayerdeployer/write/deployprojectpayer.md)
...
* `directory` is the [`IJBDirectory`](/dev/api/v2/interfaces/ijbdirectory.md) contract storing directories of terminals and controllers for each project.
