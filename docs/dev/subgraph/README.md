...
| mainnet-dev | Queries: https://api.studio.thegraph.com/query/30654/mainnet-dev/0.7.0                                      | Indexes mainnet Juicebox protocol contracts.                                   |
| goerli-dev | Queries: https://api.studio.thegraph.com/query/30654/goerli-dev/0.4.0                                      | Indexes goerli Juicebox protocol contracts. (Does not include v1 & v2 contracts)                                  |
