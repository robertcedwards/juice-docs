...
- Projects with off-chain governance (such as Snapshot) may be able to use a [Nevada Unincorporated Nonprofit Association Agreement](https://move.xyz/legal/unas/nevada.md).
- Projects with on-chain governance may be able to use a [Delaware Unincorporated Nonprofit Association Agreement](https://move.xyz/legal/unas/delaware.md).
...
- The [Foundation Bylaws](https://move.xyz/legal/foundation/foundation-bylaws.md) are a sensible starting point for forming a Washington ownerless foundation.
...
- Trusts can be valuable for maintaining confidentiality. [The terms of a Trust Agreement](https://move.xyz/legal/trusts/trust.md) are usually not accessible to third parties. Instead, a [Declaration of Trust](https://move.xyz/legal/trusts/declaration-of-trust.md) which states the high-level terms of the agreement may be notarized and provided to 3rd parties who are required to validate ownership.
...
Juicebox projects have facilitated some of the largest fundraisers of all time. A one-time fundraise may be accomplished via a [trust agreement](https://move.xyz/legal/trusts/README.md) where as the contributors are the settlors, the individual who created the project is the trustee, and the beneficiary is the individual(s) who will receive the funds.
...
- A [Trust Agreement](https://move.xyz/legal/trusts/trust-agreement.md), which is used to establish a trust.
- A [Declaration of Trust](https://move.xyz/legal/trusts/declaration-of-trust.md), which is provided to third parties.
